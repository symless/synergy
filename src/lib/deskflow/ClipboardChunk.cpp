...
ClipboardChunk *ClipboardChunk::start(ClipboardID id, uint32_t sequence, const String &size)
{
...
ClipboardChunk *ClipboardChunk::data(ClipboardID id, uint32_t sequence, const String &data)
{
...
int ClipboardChunk::assemble(deskflow::IStream *stream, String &dataCached, ClipboardID &id, uint32_t &sequence)
{
  uint8_t mark;
  String data;
