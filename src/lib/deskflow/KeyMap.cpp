...
int32_t KeyMap::getLanguageGroupID(int32_t group, const String &lang) const
{
  int32_t id = group;
...
void KeyMap::addGroupToKeystroke(Keystrokes &keys, int32_t &group, const String &lang) const
{
