...
public:
  ...
  public:
    ...
    static KeyInfo *alloc(KeyID, KeyModifierMask, KeyButton, int32_t count, const std::set<String> &destinations);
  ...
  */
  virtual bool fakeKeyRepeat(KeyID id, KeyModifierMask mask, int32_t count, KeyButton button, const String &lang) = 0;
