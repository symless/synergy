...
private:
  ...
  void setup_input_capture_session(XdpInputCaptureSession *session);
  void cb_start_input_capture_session(GObject *object, GAsyncResult *res);
